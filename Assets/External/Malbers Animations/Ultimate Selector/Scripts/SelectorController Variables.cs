...
namespace MalbersAnimations.Selector
{
    ...
    public partial class SelectorController
    {
        ...
        static readonly Keyframe[] K2 = { new(0, 1, 0, 0), new(1, 0, 0, 0) };
        ...
        public AnimationCurve SelectionCurve = new(K);

        public bool externalSelectItem = false;                     // SelectItem will be called from other script/event  ****NEW!****
        ...
        public AnimationCurve inertiaCurve = new(K2);
        ...
        #region Events
        public GameObjectEvent OnClickOnItem = new();
        public BoolEvent OnIsChangingItem = new();
        #endregion
        ...
        protected bool MainInputPress = false;
        protected bool MainInputDown = false;
        protected bool MainInputUp = false;

        public void ClickPressed(bool wasPressedThisFrame)
        {
            MainInputPress = true;
            MainInputDown = true;
            MainInputUp = false;
        ...
        public void ClickReleased(bool wasReleasedThisFrame)
        {
            MainInputPress = false;
            MainInputDown = false;

            if (externalSelectItem == true)
            {
                MainInputUp = false;
            }
            else
            {
                MainInputUp = wasReleasedThisFrame;
            }
        }
