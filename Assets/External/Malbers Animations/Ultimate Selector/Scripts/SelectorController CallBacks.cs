...
namespace MalbersAnimations.Selector
{
    ...
    {
        /// <summary> Change to the next or Previous Item Index </summary>
        ...
        /// <summary> Select an item by its MItem Script </summary>
        ...
        /// <summary>  Select an item by its name  </summary>
        ...
        /// <summary> Updates the Lock Material of the Items  </summary>
        ...
        public virtual void _PlayAnimation(string anim)
        {
            ...
            var itemAnimator = CurrentItem.GetComponentInChildren<Animator>();
